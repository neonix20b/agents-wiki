...
- [2026-07-20_dit-moscow-agent-factory-concept_v2.docx](deliverables/plans/2026-07-20_dit-moscow-agent-factory-concept_v2.docx) — **актуальная версия**: техническая концепция (Word, 10 стр., 12 разделов) — целевая архитектура, A2A+MCP, комнаты, язык шаблонов промптов, конвейер зрелости, живая среда университетов, опыт отдельным разделом, три сравнения.
