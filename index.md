...
## Deliverables
- [2026-07-20_dit-moscow-agent-factory_v5.pptx](deliverables/presentations/2026-07-20_dit-moscow-agent-factory_v5.pptx) — **актуальная раздаточная версия** (линия v2, 17 слайдов): синхронизирована с техконцепцией v2 — слайды «Язык правил» (JSON-шаблоны) и «Другие пути», факты Linux Foundation по A2A, рамка «опыт ≠ предложение», живая среда, контакты Смолева Галина.
...
_Презентации v1–v3 удалены 2026-07-20 по решению Д. Смолева как черновые итерации; история доступна в git._
