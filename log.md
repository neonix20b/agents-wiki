...
## [2026-07-20] schema | Парные форматы deliverables: docx + md
В CLAUDE.md добавлено правило: текстовые финальные документы сохраняются в двух форматах с идентичным содержанием — рабочий файл (docx/pdf) и markdown с тем же basename; md — для чтения агентами, диффов и поиска. Создана md-версия техконцепции для ДИТ: deliverables/plans/2026-07-20_dit-moscow-agent-factory-concept_v2.md. Обновлён index.md.

## [2026-07-20] deliverable | Раздаточная презентация v5 — по финальной техконцепции
На базе v2 (раздаточная линия) создана deliverables/presentations/2026-07-20_dit-moscow-agent-factory_v5.pptx, 17 слайдов: добавлены слайд «Язык правил» (JSON-шаблон с переменными, по разделу 6 концепции) и слайд «Другие пути» (no-code, заказная разработка, по 12.2–12.3); A2A усилен фактами Linux Foundation/v1.0.1/6 SDK; рамка «опыт ≠ предложение» (совместное проектирование с ДИТ, опыт Окстех как подтверждение); экосистема переработана под «живую среду»; контакты — Смолева Галина. Содержание синхронизировано с concept_v2. Обновлён index.md.

## [2026-07-20] lint | Удаление черновых версий презентаций v1–v3
По решению Д. Смолева удалены deliverables/presentations v1, v2, v3 — по сути являлись черновыми итерациями. Актуальные версии: v4 (переговорная, для личной встречи) и v5 (раздаточная, синхронизирована с техконцепцией v2). История удалённых версий сохраняется в git. Обновлён index.md.
